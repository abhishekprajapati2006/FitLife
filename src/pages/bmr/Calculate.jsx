...
import BMRResult from './Result.jsx';
...
export default function Calculate() {
  ...
  // BMI CALCULATE
  function BMI() {
    let bmr = (inputData.weight / ((height / 100) * (height / 100))).toFixed(2);
  ...
  function calculateBMR() {
    if (gender === 'male') {
        return (10 * inputData.weight) + (6.25 * height) - (5 * age) + 5;
    } else if (gender === 'female') {
        return (10 * inputData.weight) + (6.25 * height) - (5 * age) - 161;
    } else {
        return null; 
    }
}
...
console.log(`Your BMR is: ${bmr} kcal/day`);
